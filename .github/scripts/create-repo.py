...
# 1. Generate valid index.min.json array
with REPO_DIR.joinpath("index.min.json").open("w", encoding="utf-8") as f:
    json.dump(index_data, f, ensure_ascii=False, separators=(",", ":"))

# 2. Preserve your index.json structure pointing to index.min.json
index_json = {
...
# 3. Preserve your repo.json manifest
repo_data = {
    "name": "Animetail Extensions",
...
# 4. Generate fallback HTML viewer
